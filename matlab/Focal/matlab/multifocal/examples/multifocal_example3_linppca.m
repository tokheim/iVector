...
r = 1;
s = 2;
fprintf('Synthesing %i-class, %i-dimensional data, with homoscedastic rank-%i PPCA covariance model.\n',N,D,F);
...
fprintf('\nThe Linear PPCA backend, which matches the synthetic data model,\n');
